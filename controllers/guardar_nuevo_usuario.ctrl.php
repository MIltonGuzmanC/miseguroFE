...
if (!isset($_SESSION['usuario']['id_de_usuario'])) {
    ...
    if ($_SESSION['usuario']['indice_de_perfil_de_usuario'] != '1') {
        ...
        $ben->guardar_nuevo_usuario($_SESSION['usuario']['id_de_usuario'],$_POST['numero_de_id_de_usuario'],$_POST['nombres'],$_POST['apellidos'],$_POST['fecha_de_nacimiento'],$_POST['fecha_de_alta'],$_POST['cargo_ocupacion'],$_POST['telefono_de_contacto'],$_POST['email'],$_POST['provincia'],$_POST['ciudad'],$_POST['direccion'],$_POST['id_de_dependiente'],$_POST['rol_familiar']);
    }
}