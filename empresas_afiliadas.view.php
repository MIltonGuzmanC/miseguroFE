    ...
    <div class="row">
        <div class="col-12  cards-container" id="card-container-1">
            <div class="card" id="card-1">
                <div class="card-header">
                    <h5 class="card-title">
                        Agregar Nueva Empresa Afiliada
                    </h5>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                <div class="col-3 col-form-label text-sm-right pr-0">
                                                    <label for="id_de_organizacion" class="mb-0">
                                                       RUC / ID
                                                    </label>
                                                </div>
                                                <div class="col-9">
                                                    <div class="d-inline-flex align-items-center mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg px-475" id="id_de_organizacion">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-3 col-form-label text-sm-right pr-0">
                                                    <label for="nombre_de_organizacion" class="mb-0">
                                                        Nombre Comercial
                                                    </label>
                                                </div>
                                                <div class="col-9">
                                                    <div class="d-inline-flex align-items-center mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg px-475" id="nombre_de_organizacion">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="card-footer">
                                        <div class="mt-1 border-t-1 bgc-secondary-l4 brc-secondary-l2 mx-n25">
                                            <div class="offset-md-3 col-md-9 text-nowrap">
                                                <button class="btn btn-info btn-bold px-4" type="button" id="btn_guardar_organizacion">
        ...
        <div class="row">
            <div class="card acard mt-2 col-12">
                ...
                <div class="card-body px-3 pb-1">
                    <div class="col-12 form-group" id="div_lista_de_organizaciones">
